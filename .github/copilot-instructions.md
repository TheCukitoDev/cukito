...
This project cukito uses <TECH_STACK>.
...
| App       | Description                                                                 |
|-----------|-----------------------------------------------------------------------------|
| api       | Contains the api written in rust using axum where all request are received and executed. |
| app       | The main application, where the users can experiment all the logic.                     |
...
| web       | The website, where users arrive and where they see the pricing section between others.                                |
...
- Avoid writing comments that explain the code. Write code that explains itself.
